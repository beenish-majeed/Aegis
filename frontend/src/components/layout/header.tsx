      ...
      <header className="flex h-16 w-full items-center justify-between border-b border-aegis-border bg-aegis-surface px-6 z-20">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="flex h-9 w-72 items-center justify-between rounded-small border border-aegis-border bg-aegis-background px-3 text-xs text-aegis-muted hover:border-slate-300 transition-colors cursor-pointer"
          >
            <div className="flex items-center space-x-2">
              <Search className="h-4 w-4 text-aegis-muted" />
              <span>Search audit scans or commands...</span>
            </div>
            <kbd className="flex items-center space-x-0.5 rounded border border-slate-200 bg-white px-1.5 py-0.5 text-[10px] font-mono text-slate-500 shadow-2xs">
